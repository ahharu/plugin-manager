...
from plugin_manager.accounts.forms import UserChangeForm, UserCreationForm
...
class DeployUserAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        (_('Personal info'),
            {'fields': ('first_name', 'last_name', 'template')}),
        (_('Permissions'),
            {'fields': (
                'is_staff', 'is_superuser', 'user_level', 'is_active')}),
